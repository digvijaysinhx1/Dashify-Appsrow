...
const AnalyticCard = (elem) => {
  return (
    <div className="bg-white/20 backdrop-blur-sm h-119 w-80 flex items-center justify-center rounded-[26px] -rotate-6" >
      <div className="flex flex-col justify-center items-center bg-[#ffffff] gap-3 h-114 w-75 rounded-2xl">
